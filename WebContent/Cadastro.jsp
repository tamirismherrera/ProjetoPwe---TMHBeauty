...
<body>
	...
	<%
		...
		if (acao != null) {
			...
			String smtpPort = "587"; 
			String username = "tami.mherrera@gmail.com";
			String password = "minhasenha";
			String auth     = "tls";  
			SendMail sendMail =  new SendMail( smtpHost,  smtpPort,  username,  password,  auth  );
				
			String mailFrom 	= "tami.mherrera@gmail.com"; 
			String mailTo 		= email; 
			String mailSubject 	= "TMHBeauty - Obrigado por se cadastrar!"; 
			String mailBody 	=  nome + "Você acaba de criar uma conta em nosso sistema " +  "! Agora você pode logar na sua conta com seu e-mail e senha :" +senha+" e aproveitar todas as nossas promoções,para ficar ainda mais bonita."; 
			sendMail.send( mailFrom, mailTo, mailSubject, mailBody );
				
			usuario.save();
			
			response.sendRedirect("Email.jsp?email="+mailTo);
	...
	<div class="container"
		...
		<h3 style="color: #b52b57">Cadastre-se</h3>
		<form action="Cadastro.jsp" method="POST">
			...
			<div class="col-12">
				...
				<button type="button" id="btnCadastrar" class="btn btn-light"
					style="background-color: #e8baaa; margin-top: 30px"
