...
<%
	...
	int idNivelUsuario = (request.getParameter("idNivelUsuario") == null) ? 1
			: Integer.valueOf(request.getParameter("idNivelUsuario"));//1;//Integer.valueOf(request.getParameter("idNivelUsuario"));
	String nome = (request.getParameter("nome") == null) ? "" : request.getParameter("nome");
	String email = (request.getParameter("email") == null) ? "" : request.getParameter("email");
	String senha = "123";//(request.getParameter("senha") == null)? "" : request.getParameter("senha");
...
<div class="container"
	...
	<div class="row">
		<div class="col-md-6">
			...
			<h3 style="color: #b52b57; margin-bottom: 1.5rem;">Dados:</h3>
		</div>
		<div class="col-md-6" style="text-align: right;">
			<a href="Usuarios.jsp" class="btn btn-light"><i
	...
	<form action="EditarUsuario.jsp" method="POST">
		...
		<div class="row">
			<div class="col-md-2">
				<label for="idNivelUsuario">Nível: </label> <input type="text"
					class="form-control" id="idNivelUsuario" name="idNivelUsuario"
					value='<%=idNivelUsuario%>' />
			</div>
			<div class="col-md-3">
		...
		<button type="button" id="btnAlterarDados" class="btn btn-light"
			style="background-color: #e8baaa; margin-top: 30px; margin-bottom: 10px;"
